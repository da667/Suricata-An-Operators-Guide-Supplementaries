...
For Windows and Linux, enabling the SSLKEYLOGFILE env variable to log TLS master secrets is kinda straightfoward. But for macOS, its a bit of a slog. So in this directory, I have three files:
- `keylogfile-la.plist`
- `keylogfile-ld-root.plist`
- `keylogfile-la-root.plist`
